package com.estoque.api.repository.specs;
...
public class ProdutoSpecs {
  ...
  public static Specification<Produto> ativo(Boolean ativo) {
    return (root, query, builder) ->
        ativo == null ? builder.conjunction() : builder.equal(root.get("ativo"), ativo);
  }

  public static Specification<Produto> naoExcluido() {
    return (root, query, builder) -> builder.isNull(root.get("dataHoraRemocao"));
  }
  ...
  public static Specification<Produto> quantidadeEntre(
      Integer quantidadeMin, Integer quantidadeMax) {
    return (root, query, builder) -> {
  ...
  public static Specification<Produto> quantidadeFiltrada(
  ...
  public static Specification<Produto> precoFiltrado(
